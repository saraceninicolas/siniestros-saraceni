  ...
  return (
    <div className="ds">
      ...
      <div className="ds-grid">
        ...
        <section className="ds-card">
          <div className="ds-card-title"><Ico name="check" size={15} />Gestión</div>
          <div className="ds-gestion-block">
            <span className="ds-k">Última gestión realizada</span>
            <p className="ds-gestion-text">{item.gestionReal || "Sin registros."}</p>
          </div>
        </section>
